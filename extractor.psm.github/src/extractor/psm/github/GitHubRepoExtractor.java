...
public class GitHubRepoExtractor {
	...
	public static void main(String[] args) {
		GitHubRepoExtractor extractor = new GitHubRepoExtractor("./guava-50issues-50wikis.github.xmi");
		//extractor.extract("migrator", "ihategooglescholar");
		extractor.extract("2dfb541e1b38c4198d625e2096daf32ab2500e81");
		System.out.println("migrated!");
	}
	
	
	public GitHubRepoExtractor(String githubModelPath) {
		this.querier = new GitHubModelQuerier(githubModelPath);		
	}
	
	
	public void extract(String login, String password) {
		this.login = login;
		init(login, password);
	...
	public void deleteRepoIfExists() {
		try {
			this.repoId = new RepositoryId(this.login, querier.getRepository().getName());
			this.deleteRepo();
		}
		catch (Exception e) {
			System.out.println("the repo does not exist");
		}
	}
